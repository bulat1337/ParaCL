...
Program: 	Statements YYEOF
	   		{
				...
				for (const auto& stm : drv.stm_table.back())
				{
				...
				drv.ast.globalScope =
					drv.ast.construct<AST::ScopeNode>(std::move(drv.stm_table.back()));
			}
	   ;
...
Statements: Statement
			{
				...
				drv.stm_table.back().push_back(stm);
			}
		  | Statements Statement
		  	{
				auto stm = $2;
